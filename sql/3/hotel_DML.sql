...
INSERT INTO service (id, code, name, price) VALUES 
 (1, '3', 'Ironing', '3'),
 (2, '1', 'Cleaning', '5'),
 (3, '2', 'Delivery', '10'),
 (4, '4', 'Music', '15'),
...
INSERT INTO `order` (id, num, client_id, room_id, start_date, finish_date) VALUES 
...
INSERT INTO service_order (id, service_id, order_id) VALUES 
 (1, 1, 1),
 (2, 2, 1),
 (3, 3, 1),
 (4, 2, 2),

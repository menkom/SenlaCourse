...
public class DataFiller {
	...
	public void runDataIO() throws IOException, ParseException {
		...
		// clientService.loadFromDB();
		addClients();
		
		new DispayOperator().printMessage("runDataIO. Clients added.");;
		...
		// roomService.loadFromDB();
		addRooms();

		// serviceService.loadFromDB();
		addServices();
...
//		hotel.orderRoom("Tim", 44, new Date(), new Date());

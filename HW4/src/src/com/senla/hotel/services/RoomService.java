...
public class RoomService implements IService {
	...
	public void changeStatus(int number, RoomStatus roomStatus) {
		getRoomByNum(number).setStatus(roomStatus);
	}

	public void changePrice(int number, int price) {
		getRoomByNum(number).setPrice(price);
	}

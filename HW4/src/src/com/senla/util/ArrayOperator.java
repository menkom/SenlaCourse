...
public class ArrayOperator {
	...
	public boolean isFreeSpace(Object[] array) {
		...
		new DispayOperator().printMessage("ArrayOperator. isFreeSpace >" + result);
	...
	public Object[] add(Object[] array, Object element) {
		Object[] result;
		new DispayOperator().printMessage("ArrayOperator. add");
		// new DispayOperator().printMessage("ArrayOperator.");
